...
cnn_save_path = '/checkpoint/origin_cnn.pt'
attention_save_path = '/checkpoint/origin_attention.pt'
...
from origin_attention_model import Attention_Model
from origin_cnn_model import BERTCNNSentiment

cnn_model = torch.load(cnn_save_path)
attention_model = torch.load(attention_save_path)
